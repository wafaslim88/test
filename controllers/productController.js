...
var gateway = new braintree.BraintreeGateway({
    environment: braintree.Environment.Sandbox, // Set the environment to Sandbox for testing purposes
    merchantId: process.env.BRAINTREE_MERCHANT_ID, // Set the Merchant ID obtained from an environment variable
    publicKey: process.env.BRAINTREE_PUBLIC_KEY, // Set the Public Key obtained from an environment variable
    privateKey: process.env.BRAINTREE_PRIVATE_KEY, // Set the Private Key obtained from an environment variable
  });
