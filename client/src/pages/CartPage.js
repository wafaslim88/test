...
const CartPage = () => {
  ...
  //total price
  // Function to calculate the total price in DT (Tunisian Dinar)
const totalPriceDT = () => {
    try {
      let total = 0;
      cart?.map((item) => {
  ...
  return (
    <Layout>
      <div className=" cart-page" style={{marginTop:55}}>
        <div className="row">
        ...
        <div className="container " style={{width:"70%"}}>
          <div className="row " style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between"}}>
              ...
              {cart?.map((p) => (
                <div className="row card flex-row" key={p._id}>
                  ...
                  <div className="col-md-4 cart-remove-btn">
                    ...
                    <div>
                      <p  style={{marginTop:5}}>Quantity: {p.quantity}</p>
                      <button
            ...
            <div className="col-md-5 cart-summary " style={{marginRight:-50}}>
              <h2 >Cart Summary</h2>
              <p>Total | Checkout | Payment</p>
              <hr />
              <h4>Total : {totalPriceDT()} </h4>
              {auth?.user?.address ? (
                <>
                  <div className="mb-3">
